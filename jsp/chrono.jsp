...
<html>
  ...
  <body class="chrono">
    ...
    <script src="<%=hrefHome%>static/vendor/dygraph.min.js">//</script>
    <script src="<%=hrefHome%>static/vendor/plotHistory.js">//</script>
    <script src="<%=hrefHome%>static/js/chrono.js">//</script>
  </body>
</html>
