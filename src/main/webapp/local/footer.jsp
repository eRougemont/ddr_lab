  ...
  <div class="logos bg-black">
    <div class="container">
      <div class="row pt-5 pb-5">
        <div class="col gsi">
          <img src="<%=hrefHome%>local/logos/gsi.png" alt="Unige Global Studies Institute (logo)">
        </div>
        <div class="col bpun">
          <img src="<%=hrefHome%>local/logos/bpun.gif" alt="Bibliothèque Publique et Université de Neuchâtel (logo)">
        </div>
        <div class="col cec">
          <img src="<%=hrefHome%>local/logos/cec.png" alt="Centre Européen de la Culture (logo)">
        </div>
        <div class="col heid">
          <img src="<%=hrefHome%>local/logos/heid.gif" alt="Institut des Hautes Études Internationales et du Développement (logo)">
        </div>
        <div class="col rts">
          <img src="<%=hrefHome%>local/logos/rts-archives.gif" alt="Radio Télévision Suisse (logo)">
        </div>
      </div>
    </div>
  </div>
...
<script src="<%=hrefHome%>static/alix.js" charset="utf-8"></script>
